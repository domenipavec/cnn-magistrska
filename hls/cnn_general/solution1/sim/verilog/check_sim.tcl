...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.cnn_general.autotvin_in_V_V.dat"
         "c.cnn_general.autotvin_out_V_V.dat"
         "c.cnn_general.autotvin_size.dat"
         "c.cnn_general.autotvin_in_layers.dat"
         "c.cnn_general.autotvin_out_layers.dat"
         "c.cnn_general.autotvin_stream_weights.dat"
         "c.cnn_general.autotvin_max_type.dat"
         "c.cnn_general.autotvout_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.cnn_general.autotvout_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
